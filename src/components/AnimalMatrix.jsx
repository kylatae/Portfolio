...
function AnimalMatrix() {
  ...
  const handleConfirmReset = (confirmed) => {
    if (confirmed) {
      setAnimals(defaultAnimals); // Reset to default data
      // You might also want to clear other states like selectedAnimals
    }
  ...
  return (
    ...
    <table>
      ...
      <button onClick={handleResetDefaultsClick}>Reset to Default</button>

      {showConfirmReset && (
        <div className="confirm-modal">
          <h2>Are you sure you want to reset to defaults?</h2>
          <button onClick={() => handleConfirmReset(true)}>Yes</button>
